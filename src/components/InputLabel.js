    ...
    return (
      ...
      >
        <label
          ...
          className="input-label col-start-1 col-span-2 lg:col-start-2 lg:col-span-1 lg:text-center"
        >
          {this.props.label}
        </label>
        <div className="col-start-1 col-span-4 lg:col-start-3 lg:col-span-2 row-start-2 lg:row-start-1 ">
          {this.props.children}
        </div>
      </div>
    );
