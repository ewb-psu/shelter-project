...
const MainLayout = (props) => {
  ...
  return (
    <>
      ...
      <header className=" mx-5 sm:mx-16 xl:mx-16 grid grid-auto-rows grid-cols-4">
        <div
          className="col-start-1 col-span-4 lg:-col-span-1 row-start-1"
          // className={` ${
        ...
        <div className=" col-start-1 col-span-4 row-start-2 xl:col-start-2 xl:col-span-3 xl:row-start-1">
