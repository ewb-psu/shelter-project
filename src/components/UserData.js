  ...
  return (
    <Fragment>
      <div className="text-center mt-16 lg:mx-32 ">
        ...
        <p>
          Please tell us a little about yourself so we can find you the best
          services.
        </p>
      </div>
      ...
      >
        ...
        <div className="col-start-1 lg:col-start-3">
          <button
            type="submit"
            id="toResources"
            className="border transition-all border-orange-600 rounded-full md:py-4 px-8 lg:ml-auto lg:mx-0 font-medium hover:bg-orange-600 text-orange-600 hover:text-white"
            onClick={nextPage}
          >
